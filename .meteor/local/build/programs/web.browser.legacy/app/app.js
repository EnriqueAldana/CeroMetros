...
router.beforeEach(function (to, from, next) {
  var requirestAuth = to.matched.some(function (record) {
    return record.meta.requirestAuth;
  });
  ...
  if (!requirestAuth && isLogged && to.name === 'login') {
    ...
    if (permission) {
      Meteor.call('permissions.check', permission, function (error, response) {
        if (error) {
          _this.$alert.showAlertSimple('error', error.reason);
...
var Company = new Mongo.Collection('companies');
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
module.export({
  ProductionLineRepository: function () {
...
var ProductionLineRepository = new Mongo.Collection('productionlines');
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
var Product = new Mongo.Collection('products');
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
var Provider = new Mongo.Collection('providers');
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
var WarehouseRepository = new Mongo.Collection('warehouses');
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
module.export({
  WorkstationRepository: function () {
...
var WorkstationRepository = new Mongo.Collection('workstations');
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
