<template>
  <v-container>
    <v-row justify="center">
      <v-col>
        <div class="headline">Ordenes de producción</div>
      </v-col>
      <v-col cols="2" xs="16" sm="16" md="14" lg="12" xl="9">
        <div class="d-flex flex-row-reverse mb-5">
          <v-tooltip bottom>
            <template v-slot:activator="{ on }">
              <v-btn
                v-can:create.hide="'productionorders'"
                color="success"
                v-on="on"
                fab
                dark
        ...
        >
            ...
            <v-tooltip bottom>
              <template v-slot:activator="{on}">
                <v-icon v-can:edit.hide="'productionorders'" color="info" v-on="on" small class="mr-2" @click="openEditProductionOrder(item)">
                  edit
                </v-icon>
              </template>
              <span>Editar</span>
            ...
            <v-tooltip bottom>
              <template v-slot:activator="{on}">
                <v-icon v-can:delete.hide="'productionorders'" color="error" v-on="on" small class="mr-2" @click="openRemoveModal(item)">
                  delete
                </v-icon>
              </template>
              <span>Eliminar</span>
...
export default {
          ...
          filter: (value) => {
            return (
              ...
              value
                ...
                .toLocaleLowerCase()
                .indexOf(
                  this.headersFilter.status[0].statusKey.toLocaleLowerCase()
                ) !== -1
            );
          },
        },
          ...
          filter: (value) => {
            return (
              ...
              value
                ...
                .toLocaleLowerCase()
                .indexOf(
                  this.headersFilter.customer.name.toLocaleLowerCase()
                ) !== -1
            );
          },
        },
          ...
          filter: (value) => {
            return (
              ...
              value
                .toString()
                .toLocaleLowerCase()
                .indexOf(this.headersFilter.createdAt.toLocaleLowerCase()) !==
                -1
            );
          },
        },
          ...
          filter: (value) => {
            return (
              ...
              value
                ...
                .toLocaleLowerCase()
                .indexOf(
                  this.headersFilter.requiredDate.toLocaleLowerCase()
                ) !== -1
            );
          },
        },
          ...
          filter: (value) => {
            return (
              ...
              value
                ...
                .toLocaleLowerCase()
                .indexOf(
                  this.headersFilter.estimatedDeliveryAt.toLocaleLowerCase()
                ) !== -1
            );
          },
        },
  ...
  meteor: {
    ...
    productionOrder() {
      const productionordersList = ProductionOrders.find(
        {},
        {
          fields: {
            folio: 1,
      ...
      const productionordersListFiltered = productionordersList.map((po) => {
        ...
        var dateTimeCreatedAtString =
          dateTimeCreatedAt.getDate() +
          "/" +
          (parseInt(dateTimeCreatedAt.getMonth()) + 1) +
          "/" +
          dateTimeCreatedAt.getFullYear();
        po.createdAt = dateTimeCreatedAtString;

        var dateTimeEditedAt = new Date(po.editedAt);
        var dateTimeEditedAtString =
          dateTimeEditedAt.getDate() +
          "/" +
          (parseInt(dateTimeEditedAt.getMonth()) + 1) +
          "/" +
          dateTimeEditedAt.getFullYear();
        po.editedAt = dateTimeEditedAtString;

        var dateTimeRequiredDate = new Date(po.requiredDate);
        var dateTimeRequiredDateString =
          dateTimeRequiredDate.getDate() +
          "/" +
          (parseInt(dateTimeRequiredDate.getMonth()) + 1) +
          "/" +
          dateTimeRequiredDate.getFullYear();
        po.requiredDate = dateTimeRequiredDateString;

        var dateTimeEstimatedDeliveryAt = new Date(po.estimatedDeliveryAt);
        var dateTimeEstimatedDeliveryAtString =
          dateTimeEstimatedDeliveryAt.getDate() +
          "/" +
          (parseInt(dateTimeEstimatedDeliveryAt.getMonth()) + 1) +
          "/" +
          dateTimeEstimatedDeliveryAt.getFullYear();
